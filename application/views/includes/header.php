...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/css/techquery.css" />
    <title>TechQuery.net</title>
</head>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand" href="<?= base_url() ?>index.php/question/question">TechQuery<b>.net</b></a>
            </div>
